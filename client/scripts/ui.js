    ...
    _createI18nStrings() {
        ...
        window.i18nUI = {
            en: {
                ...
                TIP_BROWSER_IN_APP: 'The built-in browser of some apps may block files to download. It recommends you use JemaDrop in the system browser.',
...
class QrCode {
    constructor() {
        const qrCode = $$('qrcode');
        qrCode.innerHTML += '<span><img src="images/drop.jemaos.com.png"></span>';
